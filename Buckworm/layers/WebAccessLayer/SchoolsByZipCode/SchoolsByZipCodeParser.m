...
@implementation SchoolsByZipCodeParser
...
- (void)startParsing
{
    NSString *strURL = [NSString stringWithFormat:@"%@/api/v1/schools/nearby/%@", startOfURL, self.strZipCode];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    {
        [(id)[self callBack] SchoolsByZipCodeParserFinished:json];
    }
}
