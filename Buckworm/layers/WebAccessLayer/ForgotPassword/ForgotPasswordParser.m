...
// http://buckworm.com/laravel/index.php/api/v1/reset/{username}
...
- (void)startParsing
{
    NSString *strURL = [NSString stringWithFormat:@"%@/api/v1/reset/%@", startOfURL, self.strUsername];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    {
        [(id)[self callBack] ForgotPasswordParserFinished:json];
    }
}
